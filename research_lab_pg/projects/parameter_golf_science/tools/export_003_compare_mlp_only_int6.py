...
def main() -> int:
    parser = argparse.ArgumentParser(description="Controlled uniform int8 vs MLP-only int6 export comparison on a locked checkpoint.")
    ...
    log0("experiment_id:export_003_selective_precision_retention_after_uniform_int6_failure", rank)
    ...
    log0("precision_config:uniform_int8 vs mlp_int6_else_int8", rank)
    ...
    results: dict[str, Any] = {
        "experiment_id": "export_003_selective_precision_retention_after_uniform_int6_failure",
    ...
    if rank == 0:
        ...
        candidate = results["artifacts"]["mlp_int6_else_int8"]
        results["comparison"] = {
