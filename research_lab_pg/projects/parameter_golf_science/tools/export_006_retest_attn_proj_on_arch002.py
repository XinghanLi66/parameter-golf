...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Controlled arch_002 export retest with uniform int8, MLP-only int6, and MLP+attn.proj int6."
    )
    ...
    parser.add_argument("--historical-summary", required=True, help="Path to export_005 summary.json for historical comparison.")
    ...
    log0("experiment_id:export_006_retest_attn_proj_subset_on_arch_002_checkpoint", rank)
    ...
    results: dict[str, Any] = {
        "experiment_id": "export_006_retest_attn_proj_subset_on_arch_002_checkpoint",
    ...
    if rank == 0:
        ...
        results["comparison"] = {
            ...
            "vs_historical_export_005_candidate": {
