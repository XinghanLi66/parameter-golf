...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Controlled arch_003 export comparison with uniform int8, MLP-only int6, and MLP+attn.proj int6."
    )
    ...
    parser.add_argument("--baseline-summary", required=True, help="Path to export_006 summary.json for baseline comparison.")
    ...
    log0("experiment_id:arch_003_bigramhash_4096_smeargate_under_export_006_protocol", rank)
    ...
    results: dict[str, Any] = {
        "experiment_id": "arch_003_bigramhash_4096_smeargate_under_export_006_protocol",
