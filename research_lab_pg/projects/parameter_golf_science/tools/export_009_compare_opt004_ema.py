...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Controlled opt_004 EMA export comparison with uniform int8, MLP-only int6, and MLP+attn.proj int6."
    )
    ...
    parser.add_argument("--baseline-summary", required=True, help="Path to opt_003 summary.json for baseline comparison.")
    ...
    log0("experiment_id:opt_004_arch_003_muon_wd004_plus_ema", rank)
    ...
    results: dict[str, Any] = {
        "experiment_id": "opt_004_arch_003_muon_wd004_plus_ema",
    ...
    if rank == 0:
        ...
        results["comparison"] = {
            ...
            "vs_opt003_mlp_int6_plus_attn_proj_int6_else_int8": {
            ...
            "uniform_int8_vs_opt003_uniform_int8": {
                "beat_baseline": uniform["val_bpb"] < baseline_uniform["val_bpb"],
                "under_16mb_cap": uniform["total_submission_bytes"] < 16_000_000,
            },
            "mixed_precision_vs_uniform_int8_this_checkpoint": {
                "mlp_int6_else_int8_val_bpb_delta": mlp["val_bpb"] - uniform["val_bpb"],
                "mlp_int6_plus_attn_proj_int6_else_int8_val_bpb_delta": candidate["val_bpb"] - uniform["val_bpb"],
            },
        }
