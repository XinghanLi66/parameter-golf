...
def main() -> int:
    parser = argparse.ArgumentParser(description="Controlled uniform-int8 export comparison for arch_005 11L.")
    ...
    parser.add_argument("--baseline-summary", required=True, help="Path to the locked arch_004 summary.json baseline.")
