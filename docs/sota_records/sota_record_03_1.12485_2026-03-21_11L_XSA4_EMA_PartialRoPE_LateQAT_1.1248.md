# SOTA Record #3: 2026-03-21_11L_XSA4_EMA_PartialRoPE_LateQAT_1.1248

- **Rank**: #3 (by val_bpb, lower is better)
- **val_bpb (post-export)**: `1.12484502`
- **val_bpb (pre-quant)**: `1.1418`
- **Artifact bytes**: `15612308` / 16,000,000
- **Author**: Jack Princz
