# SOTA Record #12: 2026-03-19_SlidingWindowEval

- **Rank**: #12 (by val_bpb, lower is better)
- **val_bpb (post-export)**: `1.19250007`
- **val_bpb (pre-quant)**: `1.2196`
- **Artifact bytes**: `15874829` / 16,000,000
- **Author**: Matthew Li
