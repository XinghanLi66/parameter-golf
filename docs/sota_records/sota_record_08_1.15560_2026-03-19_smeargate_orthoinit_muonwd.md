# SOTA Record #8: 2026-03-19_smeargate_orthoinit_muonwd

- **Rank**: #8 (by val_bpb, lower is better)
- **val_bpb (post-export)**: `1.1556`
- **val_bpb (pre-quant)**: `?`
...
```json
{
  ...
  "quantization": "int6",
  "compression": "zstd-22",
  "artifact_size_bytes": 15878809,
  "model_params": 22368840,
  "train_steps": 12047,
  ...
  "post_quant_standard_val_bpb": 1.1891,
  "post_quant_standard_val_loss": 2.0077,
  "quantization_gap_bpb": 0.0001
}
```
